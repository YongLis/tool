...
/**
 * This is a simple implementation of the RC4Util (tm) encryption algorithm. The
 ...
 * find a *free* JCE implementation with RC4Util (tm) at Cryptix
 * (http://www.cryptix.org/).
 * <p>
 * Note that RC4Util (tm) is a trademark of RSA Data Security, Inc. Also, if you are
 * within USA, you may need to acquire licenses from RSA to use RC4Util. Please
